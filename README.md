...
* [`docs/ALGORITHMS.md`](https://github.com/pedrohenriquecoimbra/miniflux/blob/v0.1.1/docs/ALGORITHMS.md) — the mathematics: every formula, constant,
  default, edge case and citation (1,656 lines).
* [`docs/CONTRACT.md`](https://github.com/pedrohenriquecoimbra/miniflux/blob/v0.1.1/docs/CONTRACT.md) — the plumbing: every module, signature, meta key,
...
One `.ini` file, every key documented in [`examples/miniflux.ini`](https://github.com/pedrohenriquecoimbra/miniflux/blob/v0.1.1/examples/miniflux.ini) and
...
[`docs/BENCHMARK.md`](https://github.com/pedrohenriquecoimbra/miniflux/blob/v0.1.1/docs/BENCHMARK.md). numpy is a speed switch and nothing else: every
...
[`docs/VALIDATION.md`](https://github.com/pedrohenriquecoimbra/miniflux/blob/v0.1.1/docs/VALIDATION.md) — read it before you report a miniflux number.
Where miniflux and `ONEFlux_preproc` disagree numerically, `ONEFlux_preproc` is right and
miniflux has a bug.

## Licence and provenance

EUPL-1.2. See [`LICENCE`](https://github.com/pedrohenriquecoimbra/miniflux/blob/v0.1.1/LICENCE); copyright (c) 2026 Pedro Henrique Herig Coimbra.
...
[`NOTICE`](https://github.com/pedrohenriquecoimbra/miniflux/blob/v0.1.1/NOTICE) and §15 of `ALGORITHMS.md`.
